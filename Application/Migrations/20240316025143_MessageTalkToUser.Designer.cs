...
namespace Application.Migrations
{
    ...
    [Migration("20240316025143_MessageTalkToUser")]
    partial class MessageTalkToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Application.Domain.Entity.MessageTallkToUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Application.Domain.Entity.MessageTallkToUser", b =>
                {
                    b.HasOne("Application.Domain.Entity.Message", "Message")
                        .WithMany("MessageTallkToUsers")
                        .HasForeignKey("MessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Application.Domain.Entity.TalkToUser", "TalkToUser")
                        .WithMany("MessageTallkToUsers")
            ...
            modelBuilder.Entity("Application.Domain.Entity.Message", b =>
                {
                    b.Navigation("MessageTallkToUsers");
                });
